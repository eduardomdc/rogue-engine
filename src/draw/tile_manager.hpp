...
public:
    ...
    static void drawAscii(SDL_Texture* tileset, SDL_Rect src, SDL_Rect dest, const char* id, color foreRgb, color backRgb, int tileHeight, int tileWidth, int setHeight, int setWidth);
};
